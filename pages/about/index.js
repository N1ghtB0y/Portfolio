    ...
    xl:flex-row gap-x-6">
      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        <div className="flex flex-1 xl:gap-x-6">
            {/* 1_count */}
            <div className="relative flex-1 position:relative mb-10">
              <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2" >
                <CountUp start={0} end={99999} duration={100} /> 
              </div>
            ...
            {/* 2_count */}
            <div className="relative flex-1 position:relative">
              <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2" >
                <CountUp start={0} end={99999} duration={100} /> 
              </div>
            ...
            <div className="relative flex-1 position:relative">
              <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2" >
                <CountUp start={99999} end={0} duration={100} /> 
              </div>
            ...
            return(
              <div 
               ...
               className={`${index === itemIndex && 
                'text-accent after:w-[100%] after:bg-white after:transition-all after:duration-300'}
